...
<table class="form" style="float: left; margin-right: 20px">
	...
	<tbody>
		...
		<tr id="<?php echo ChiveCHtml::$idPrefix; ?>settingSize">
			<td>
		...
		<tr id="<?php echo ChiveCHtml::$idPrefix; ?>settingScale">
			<td>
		...
		<tr id="<?php echo ChiveCHtml::$idPrefix; ?>settingValues">
			<td>
		...
		<tr id="<?php echo ChiveCHtml::$idPrefix; ?>settingCollation">
			<td>
		...
		<tr id="<?php echo ChiveCHtml::$idPrefix; ?>settingDefault">
			<td>
				<?php echo CHtml::activeLabel($column, 'COLUMN_DEFAULT'); ?>
			</td>
			<td colspan="2">
				<?php echo CHtml::activeTextField($column, 'COLUMN_DEFAULT'); ?>
				<div class="small" id="<?php echo ChiveCHtml::$idPrefix; ?>settingDefaultNullHint">
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="2">
				...
				<!---
				<?php echo CHtml::activeRadioButton($column, 'attribute', array('value' => '', 'id' => ChiveCHtml::$idPrefix . 'Column_attribute_')); ?>
		...
		<tr>
			...
			<td>
				...
				<!---
				<?php echo CHtml::activeRadioButton($column, 'attribute', array('value' => 'unsigned', 'id' => ChiveCHtml::$idPrefix . 'Column_attribute_unsigned')); ?>
			...
			<td>
				...
				<!---
				<?php echo CHtml::activeRadioButton($column, 'attribute', array('value' => 'unsigned zerofill', 'id' => ChiveCHtml::$idPrefix . 'Column_attribute_unsignedzerofill')); ?>
		...
		<tr>
			...
			<td colspan="2">
				...
				<!---
				<?php echo CHtml::activeRadioButton($column, 'attribute', array('value' => 'on update current_timestamp', 'id' => ChiveCHtml::$idPrefix . 'Column_attribute_on_update_current_timestamp')); ?>
